 ...
 */
	...
	include_once (MOTTE_SRC.'/misc/mteAjaxXMLResponse.class.php');
	include_once (MOTTE_SRC.'/misc/mteAjaxStringResponse.class.php');
	include_once (MOTTE_SRC.'/misc/mteAjaxResponse.class.php');
?>
