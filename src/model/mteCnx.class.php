 ...
 */
    abstract class mteCnx {
        ...
        */
        ...
        /**
         * recibe comentario y resultado(ok o error)
         *
         * @access protected
         * @param
         * @return
         */
        protected function addLog($result = '',$comm = '', $commSql = ''){
            $this->setEventCode($result);
            $this->setEventMsg($commSql);

            if ($commSql != ''){
                $comm .= ' - '.$commSql;
            }
            if($this->getLog() instanceof mteLogSql){
                $this->getLog()->addEvent($result,$this->getUser(),$comm);
            }
            if($this->getDebug()){
                $this->displayDebug($comm);
            }
        }
